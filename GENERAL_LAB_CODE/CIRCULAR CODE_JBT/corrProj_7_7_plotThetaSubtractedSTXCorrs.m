...
% Colgin Lab
curDir = pwd;
dataDir = 'I:\JBT_RERUN\DATASET'; %PC
% dataDir = 'D:\CORR_PROJECT_RERUN\DATASET'; %LAPTOP, EXTERNAL
cd(dataDir);

saveFigs = 1; %set to 1 to save figs
saveDir = 'I:\JBT_RERUN\RESULTS\Theta_Subtracted_SpkTm_CrossCorrs';
...
shufColMat = colormap('gray'); %define_cust_color_map('LightGray', 'SlateGray', 10);
