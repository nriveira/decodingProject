function RunBayesianDecoder_ripple_v3_afterReward(Path,CSClist,Outdir,cellList,spktime_fd,trackdata,plotOnly)
%% This version detect ripples outside of rest box after reward
outdir = strcat(Outdir,'\BayesianDecoding_ripple_outsideOfRestBox_afterReward');
if ~isdir(outdir)
    mkdir(outdir)
end
